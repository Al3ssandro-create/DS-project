...
public class ResponseReconnectMessage extends ConnectMessage {
    ...
    public ResponseReconnectMessage(int sequenceNumber, int port, String ip, String username, UUID userId, UUID newUserId, Set<UserTuple> disconnectedUser) {
        super(sequenceNumber, port, ip, username, userId);
